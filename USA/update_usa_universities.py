...
def fetch_universities(country_name, page_size=2000):
...
def main():
    ...
    csv_path = os.path.join(os.path.dirname(__file__), "usa_universities.csv")
    with open(csv_path, mode='w', encoding='utf-8-sig', newline='') as f:
        ...
        for item in data:
            ...
            # Replace internal double quotes with single quotes and commas with spaces
